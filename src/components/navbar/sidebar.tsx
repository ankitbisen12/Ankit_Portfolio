    ...
    <React.Fragment>
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
          ...
          <CornerDownLeftIcon size={20} className='text-white cursor-pointer' onClick={() => setOpen(prevState => !prevState)} />
        </div>

        <nav className="px-6 py-6 space-y-6 text-zinc-300">
          <NavLinks content="Skills" href="#skills" scrollToSection={() => scrollToSection("skills")} />
          <NavLinks content="Experience" href="#experience" scrollToSection={() => scrollToSection("experience")} />
          <NavLinks content="Projects" href="#projects" scrollToSection={() => scrollToSection("projects")} />
          <NavLinks content="Contact" href="#contact" scrollToSection={() => scrollToSection("contact")} />
        </nav>
      </aside>
    </React.Fragment>
  );
